...
export function DownloadSection() {
  ...
  const checksums = [
    {
      file: "HushWrite_1.2.1_x64-setup.exe",
      platform: "Windows 64-bit Installer (.exe) · Code Signed",
      sha256: "50d8c5b27ebc4dc48bdb20a80bba43395ce988f68a915603dab8b0a9bb25edb9",
    },
    {
      file: "HushWrite_1.2.1_x64_en-US.msi",
      platform: "Windows MSI Package · Code Signed",
      sha256: "ccdb820a922100c93f61b3753dec75de059a0a50bdb00bcafcdeb465ade54ca4",
    },
    {
      file: "HushWrite_1.2.1_aarch64.dmg",
      platform: "macOS Apple Silicon (M1/M2/M3/M4)",
      sha256: "95d8c8e26b8e9fe8f5c2a6eb089cb1857d2053d70fe339c635391494016f60d5",
    },
    {
      file: "HushWrite_1.2.1_x64.dmg",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-12">
          ...
          <div className="p-6 sm:p-8 rounded-2xl bg-white border border-neutral-200/90 flex flex-col justify-between shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08),0_1px_3px_rgba(0,0,0,0.04)] relative overflow-hidden">
            ...
            <div className="space-y-3">
              ...
              <a
                href="/downloads/HushWrite_1.2.1_x64_en-US.msi"
                download="HushWrite_1.2.1_x64_en-US.msi"
                onClick={() => handleDownloadClick("HushWrite_1.2.1_x64_en-US.msi", "Windows MSI")}
          ...
          <div className="p-6 sm:p-8 rounded-2xl bg-white border border-neutral-200/90 flex flex-col justify-between shadow-[0_20px_50px_-12px_rgba(0,0,0,0.08),0_1px_3px_rgba(0,0,0,0.04)] relative overflow-hidden">
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-col gap-2.5">
                ...
                <a
                  href="/downloads/HushWrite_1.2.1_x64.dmg"
                  download="HushWrite_1.2.1_x64.dmg"
                  onClick={() => handleDownloadClick("HushWrite_1.2.1_x64.dmg", "macOS Intel")}
        ...
        <div className="p-6 sm:p-8 rounded-2xl bg-white border border-neutral-200/90 shadow-sm mb-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            ...
            <div className="p-4 rounded-xl bg-neutral-50 border border-neutral-200/80 flex flex-col justify-between">
              ...
              <a
                href="https://github.com/alexgutscher26/HushWrite/releases/tag/v1.2.1"
                target="_blank"
                rel="noopener noreferrer"
