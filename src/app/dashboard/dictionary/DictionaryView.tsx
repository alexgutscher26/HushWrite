...
export const DOMAIN_PACKS: readonly DomainPack[] = [
  {
    ...
    entries: [
      ...
      { pattern: "tan stack", replacement: "TanStack" },
      ...
      { pattern: "hush right", replacement: "HushWrite" },
      { pattern: "hush white", replacement: "HushWrite" },
    ],
  },
  {
    id: "ai-ml-infra",
    ...
    entries: [
      ...
      { pattern: "koo dah", replacement: "CUDA" },
      { pattern: "whisper ex", replacement: "WhisperX" },
      { pattern: "l l m", replacement: "LLM" },
      { pattern: "r a g", replacement: "RAG" },
      { pattern: "o lama", replacement: "Ollama" },
      { pattern: "hugging face", replacement: "Hugging Face" },
      { pattern: "lang chain", replacement: "LangChain" },
      { pattern: "fine tuning", replacement: "fine-tuning" },
    ],
  },
  {
    id: "backend-systems",
    ...
    entries: [
      ...
      { pattern: "post grass", replacement: "PostgreSQL" },
      ...
      { pattern: "koober nettes", replacement: "Kubernetes" },
      { pattern: "koober neties", replacement: "Kubernetes" },
      { pattern: "a sync", replacement: "async" },
      { pattern: "a wait", replacement: "await" },
      { pattern: "docker", replacement: "Docker" },
      { pattern: "docker compose", replacement: "docker-compose" },
      ...
      { pattern: "o auth", replacement: "OAuth" },
    ],
  },
  {
    id: "cloud-devops",
    ...
    entries: [
      ...
      { pattern: "v s code", replacement: "VS Code" },
